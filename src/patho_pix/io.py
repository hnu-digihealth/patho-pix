...
def load_wsi(path, use_largeimage=True):
    ...
    pathdir_tiles_img = tempfile.TemporaryDirectory(prefix="patho-pix.tmp.",
                                                    suffix=".tiles_img")
    # Load WSI scan via histolab
    wsi_slide = Slide(path=path, 
...
def load_mask(path, use_largeimage=True):
    ...
    pathdir_tiles_mask = tempfile.TemporaryDirectory(prefix="patho-pix.tmp.",
                                                     suffix=".tiles_mask")
